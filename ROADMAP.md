...
service is shipped or provisioned. M3-02 is in progress under its
[acceptance plan](docs/m3-02-acceptance.md); M3-03 through M3-06 remain planned.
M3 is incomplete.
...
| M3-02 | Workers deployment foundation | **In progress.** Actual React/Vite Static Assets, bounded HTTP identification, separate Pages/Workers builds, local runtime/browser checks and proposed GitHub Builds setup. Completion awaits reviewed evidence and final-revision CI. |
