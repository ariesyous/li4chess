...
| M3-08 | Authenticated private rematch consent and fresh creation | **In progress: acceptance planning.** PR #18 merged at `229e325`; post-merge CI must pass before implementation. The [pre-change inventory](docs/m3-08-acceptance.md) defines same-four-principal consent, deliberate entry, fresh identity/seed, recovery and unchanged prior results. Hosted activation and M4 remain separate. |
