...
and producer provenance. The strict private multiplayer protocol is implemented; M3-06 has local Windows/Linux complete-game and recovery evidence. Browser CPU search
...
**M3-04 complete (2026-09-07):** maintained SQLite GameRoom authority, persisted
...
**M3-06 locally complete (2026-09-07):** [inventory](docs/m3-06-acceptance.md),
...
| M3-08 | Authenticated private rematch consent and fresh creation | **In progress: acceptance planning.** PR #18 merged at `229e325`; post-merge CI 34180878295 and Pages passed before implementation. The [pre-change inventory](docs/m3-08-acceptance.md) defines same-four-principal consent, deliberate entry, fresh identity/seed, recovery and unchanged prior results. Hosted activation and M4 remain separate. |
