...
protocol integration. M3-05 implementation is under final acceptance; M3-06 remains planned. M3 is incomplete.
...
| M3-05 | Multiplayer protocol | **Implementation under final acceptance.** Authenticated guests, private membership/seats, strict wire schemas, exact retries and browser reconnect/resync are implemented; final evidence and CI pending. |
