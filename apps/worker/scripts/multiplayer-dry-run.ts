...
for(const forbidden of ["TEST_KEY","PLAYER_KEYS","fixture-crash","m3_05_interruption","nonexistent_fault_table","test/worker.ts","M3_06_KEY","/__m3-06","campaign_fixture","campaign interruption","M3_07_READER_BUILD","replay-outage","replay-download-harness"])assert(!bundle.includes(forbidden),`Test-only hook in bundle: ${forbidden}`);
